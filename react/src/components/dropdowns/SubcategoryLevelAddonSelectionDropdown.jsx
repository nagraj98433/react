...
function SubcategoryLevelAddonSelectionDropdown({
  handleClose,
  subCatId,
  subCatAddons,
}) {
      ...
      {addonGroup?.length ? (
        addonGroup.map((addon) => (
          <Form.Check
            ...
            defaultChecked={subCatAddons.includes(addon?.addon_group_id)}
            onClick={(e) => {
              e.stopPropagation();
...
export default SubcategoryLevelAddonSelectionDropdown;
